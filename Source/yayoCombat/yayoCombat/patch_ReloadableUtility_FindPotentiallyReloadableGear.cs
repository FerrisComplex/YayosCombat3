...
{
    [HarmonyPostfix]
    private static IEnumerable<Pair<CompApparelReloadable, Thing>> Postfix(IEnumerable<Pair<CompApparelReloadable, Thing>> __result, Pawn pawn, List<Thing> potentialAmmo)
    {
